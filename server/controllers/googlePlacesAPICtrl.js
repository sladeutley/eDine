...
module.exports.searchRestaurantsAPI = (req, res, next) => {
  ...
  https.get(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${req.query.latitude},${req.query.longitude}&radius=10000&type=restaurant&keyword=${req.query.keyword}&key=${googlePlacesKey}`, (resp) => {
  ...
  module.exports.getRestaurantDetails = (req, res, next) => {
    ...
    https.get(`https://maps.googleapis.com/maps/api/place/details/json?placeid=${req.params.id}&key=${googlePlacesKey}`, resp => {
